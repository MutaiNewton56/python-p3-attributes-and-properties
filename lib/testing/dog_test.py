...
class TestDog:
    ...
    def test_name_not_empty(self):
        ...
        Dog(name="", breed="Pug")  # Using a valid breed to focus on name validation
    ...
    def test_name_string(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name=123, breed="Pug")  # Using a valid breed to focus on name validation
        sys.stdout = sys.__stdout__
        assert(captured_out.getvalue() == "Name must be string between 1 and 25 characters.\n")
    ...
    def test_name_under_25(self):
        ...
        captured_out = io.StringIO()
        sys.stdout = captured_out
        Dog(name="What do dogs do on their day off? Can't lie around - that's their job.", breed="Pug")  # Using a valid breed to focus on name validation
        sys.stdout = sys.__stdout__
        assert(captured_out.getvalue() == "Name must be string between 1 and 25 characters.\n")
